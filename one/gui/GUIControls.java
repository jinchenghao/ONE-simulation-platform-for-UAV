...
public class GUIControls extends JPanel implements ActionListener, ChangeListener {
	...
	private static final String TEXT_PAUSE = "暂停仿真";
	private static final String TEXT_PLAY = "开始仿真";
	private static final String TEXT_PLAY_UNTIL = "开始仿真直到结束...";
	private static final String TEXT_STEP = "向前一个时间间隔";
	private static final String TEXT_FFW = "启动/关闭 快进";
	private static final String TEXT_UP_CHOOSER = "界面刷新：";
	private static final String TEXT_SCREEN_SHOT = "截屏";
	private static final String TEXT_SIMTIME = "仿真时间 - "+ 
		"点击强制更新，右键单击更改显示格式";
	private static final String TEXT_SEPS = "每秒模拟的秒数";
	...
	private static final String SCREENSHOT_FILE = "截图";
